...
class TestCaseUploadAPITest(APITestCase):
    ...
    def test_filter_file_name(self):
        ...
        # test .res support: .res should be recognized as output file
        self.assertEqual(self.api.filter_name_list(["1.in", "1.res", "2.in", "2.out"], spj=False),
                         ["1.in", "1.res", "2.in", "2.out"])

        # test .res priority: when same base has both .out and .res, prefer .res
        self.assertEqual(self.api.filter_name_list(["1.in", "1.out", "1.res"], spj=False),
                         ["1.in", "1.res"])
